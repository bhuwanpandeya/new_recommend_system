                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="index.php" method="post" class="registration-form" id="signup">
				                    	<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="middlename" placeholder="Middle name..." class="form-last-name form-control" id="form-middle-name-name">
                                        </div>
				                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="sr-only" for="form-username">Username</label>
                                            <input type="text" name="username" placeholder="Username..." class="form-email form-control" id="form-susername">
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="form-password">Password</label>
                                            <input type="password" name="password" placeholder="Password..." class="form-email form-control" id="form-spassword">
                                        </div>
